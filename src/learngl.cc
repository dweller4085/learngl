...
namespace {
    constexpr float magic_mouse_sensitivity_constant = 0.0004f;
    ...
    struct t_simple_cube {
        static constexpr int vertex_count = 36;
        
        static function create(char const * texture_path) -> t_simple_cube;
        
        function render() -> void;
        function set_mvp(mat4 const& mvp) -> void;
    ...
    function load_texure(char const * path) -> uint;
...
function ::t_app::init() -> void {
    ...
    cube = t_simple_cube::create(tile_path);
}
...
function ::t_app::render() -> void {
    ...
    cube.set_mvp(camera.projection * camera.view * glm::identity<mat4>());
    cube.render();
...
function ::t_camera::update(float dt) -> void {
    if (can_move) {
        { // update pitch and yaw angle values
            let delta = cursor::get_delta() * magic_mouse_sensitivity_constant;
            delta.x *= sensitivity;
...
function t_simple_cube::create(char const * texture_path) -> t_simple_cube {
    float static vertices[vertex_count * 5] = {
    ...
    return {
        ...
        .texture = load_texure(texture_path),
    };
}

function t_simple_cube::render() -> void {
...
function t_simple_cube::set_mvp(mat4 const& mvp) -> void {
